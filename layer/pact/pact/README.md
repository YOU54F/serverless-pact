...
This version (1.66.0) of the Pact standalone executables package contains:

  * pact gem 1.41.0
  * pact-mock_service gem 3.1.0
  * pact-support gem 1.10.2
  * pact-provider-verifier gem 1.23.1
